...
namespace SpotifAds
{
    ...
    {
        private ProxyServer proxyServer = new ProxyServer(userTrustRootCertificate: true, rootCertificateName: "Victory Root Certificate", rootCertificateIssuerName: "Victory Issuer Certificate");
